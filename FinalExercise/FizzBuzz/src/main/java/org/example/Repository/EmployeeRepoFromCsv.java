...
public class EmployeeRepoFromCsv implements EmployeeRepository {
    @Override
    public List<Employee> getAllEmployees() {
        try {
            ClassLoader classLoader = getClass().getClassLoader();
            InputStream is = ClassLoader.getSystemResourceAsStream("datastore.csv");
    ...
    private List<List<String>> parseCsv(InputStream csvInput, char csvSeparator) {
